...
class RptStaffDegnInfoApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffDegnInfoApp()
	{
		f1=new JFrame("Report of Staff Designation Information");
		p1=new JPanel();
		p2=new JPanel();
		gl51=new GridLayout(5,1);
		flw=new FlowLayout();
		
		lHead=new JLabel("Staff Designation Information",JLabel.CENTER);
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Information ["+Degn+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblstaffinfo  where Designation='"+Degn+"'");
				slno=1;
				rw=0;
		...
		catch(SQLException se)
		{
			...
			dlg.showMessageDialog(f1,"Unable to Get Data","Detail Report",0);
		}
	}
...
class RptStaffDegnInfo
{
	public static void main(String[] s)
	{
		RptStaffDegnInfoApp rpt1=new RptStaffDegnInfoApp();
	}
}