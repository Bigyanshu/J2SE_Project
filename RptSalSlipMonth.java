...
class RptSalSlipMonthYearApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public void doConnect()
	{
		...
		try
		{
			...
			Month=dlg.showInputDialog(f1,"Enter Month : ","Detail Report",1);
			Year=dlg.showInputDialog(f1,"Enter Year :","Detail Repert",1);
			...
			{
				lHead.setText("Staff Salary Slip Information ["+Month+","+Year+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblsalslip where MonthOf='"+Month+"' AND Year='"+Year+"'");
				slno=1;
				rw=0;
...
class RptSalSlipMonth
{
	public static void main(String[] s)
	{
		RptSalSlipMonthYearApp rpt1=new RptSalSlipMonthYearApp();
	}
}