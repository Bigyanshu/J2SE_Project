...
class RptStaffLeaveApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffLeaveApp()
	{
		f1=new JFrame("Staff Leave Information");
		p1=new JPanel();
		p2=new JPanel();
...
class RptStaffLeave
{
	...
	{
		RptStaffLeaveApp rpt1=new RptStaffLeaveApp();
	}
}