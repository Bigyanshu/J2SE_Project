...
class RptStaffInfoApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffInfoApp()
	{
		f1=new JFrame("Staff Information");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		catch(SQLException se)
		{
			...
			dlg.showMessageDialog(f1,"Unable to Get Data","Report",0);
		}
	}
...
class RptStaffInfo
{
	...
	{
		RptStaffInfoApp rpt1=new RptStaffInfoApp();
	}
}