...
class RptStaffSIDAttendApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffSIDAttendApp()
	{
		f1=new JFrame("Report of Staff Attend Information StaffID-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			sid=dlg.showInputDialog(f1,"Enter Staff ID : ","Detail Report",1);
			...
			{
				lHead.setText("Staff Attend ["+sid+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblstaffattend where SID='"+sid+"'");
				slno=1;
				rw=0;
...
class RptStaffSIDAttend
{
	public static void main(String[] s)
	{
		RptStaffSIDAttendApp rpt1=new RptStaffSIDAttendApp();
	}
}