...
class RptStaffDateAttendApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffDateAttendApp()
	{
		f1=new JFrame("Report of Staff Attend Information Date-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			Date=dlg.showInputDialog(f1,"Enter Date :","Detail Report",3);
			...
			{
				lHead.setText("Staff Attend ["+Date+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblstaffattend where Date='"+Date+"'");
				slno=1;
				rw=0;
...
class RptStaffDateAttend
{
	public static void main(String[] s)
	{
		RptStaffDateAttendApp rpt1=new RptStaffDateAttendApp();
	}
}