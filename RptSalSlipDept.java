...
class RptSalSlipDeptApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptSalSlipDeptApp()
	{
		f1=new JFrame("Report of Staff Salary Slip Information Department-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Salary Slip Information ["+dept+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblsalslip where Department='"+dept+"'");
				slno=1;
				rw=0;
...
class RptSalSlipDept
{
	public static void main(String[] s)
	{
		RptSalSlipDeptApp rpt1=new RptSalSlipDeptApp();
	}
}