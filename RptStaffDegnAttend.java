...
class RptStaffDegnAttendApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffDegnAttendApp()
	{
		f1=new JFrame("Report of Staff Attend Information Designation-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Attend ["+Degn+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblstaffattend where Designation='"+Degn+"'");
				slno=1;
				rw=0;
...
class RptStaffDegnAttend
{
	public static void main(String[] s)
	{
		RptStaffDegnAttendApp rpt1=new RptStaffDegnAttendApp();
	}
}