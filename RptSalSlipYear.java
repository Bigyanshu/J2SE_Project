...
class RptSalSlipYearApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public void doConnect()
	{
		...
		try
		{
			...
			Year=dlg.showInputDialog(f1,"Enter Year :","Detail Report",1);
			lHead.setText("Staff Salary Slip Information ["+Year+"]");
...
class RptSalSlipYear
{
	public static void main(String[] s)
	{
		RptSalSlipYearApp rpt1=new RptSalSlipYearApp();
	}
}