...
class RptLeaveApprovalDateApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptLeaveApprovalDateApp()
	{
		f1=new JFrame("Report of Staff Leave Approval Information Date-Wise");
		p1=new JPanel();
		p2=new JPanel();
		...
		lOrgn=new JLabel("    B P College of Technology & Management");
	...
	public void doConnect()
	{
		...
		{
			stmtSelect=conn.createStatement();
			Date=dlg.showInputDialog(f1,"Enter Date :","Detail Report",1);
			...
			{
				lHead.setText("Staff Leave Approval Information ["+Date+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblleaveapprov where FromDate='"+Date+"'");
				slno=1;
				rw=0;
...
class RptLeaveApprovalDate
{
	public static void main(String[] s)
	{
		RptLeaveApprovalDateApp rpt1=new RptLeaveApprovalDateApp();
	}
}