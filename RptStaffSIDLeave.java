...
class RptStaffSIDLeaveApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffSIDLeaveApp()
	{
		f1=new JFrame("Report of Staff Leave Information StaffID-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Leave Inforamtion ["+sid+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblleave where sID='"+sid+"'");
				slno=1;
				rw=0;
...
class RptStaffSIDLeave
{
	public static void main(String[] s)
	{
		RptStaffSIDLeaveApp rpt1=new RptStaffSIDLeaveApp();
	}
}