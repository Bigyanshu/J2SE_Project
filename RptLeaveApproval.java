...
class RptLeaveApprovalApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptLeaveApprovalApp()
	{
		f1=new JFrame("Staff Leave Approval Information");
		p1=new JPanel();
		p2=new JPanel();
...
class RptLeaveApproval
{
	public static void main(String[] s)
	{
		RptLeaveApprovalApp rpt1=new RptLeaveApprovalApp();
	}
}