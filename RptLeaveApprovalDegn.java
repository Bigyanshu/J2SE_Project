...
class RptLeaveApprovalDegnApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptLeaveApprovalDegnApp()
	{
		f1=new JFrame("Report of Staff Leave Approval Information Designation-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Leave Approval Information ["+Degn+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblleaveapprov where Designation='"+Degn+"'");
				slno=1;
				rw=0;
...
class RptLeaveApprovalDegn
{
	public static void main(String[] s)
	{
		RptLeaveApprovalDegnApp rpt1=new RptLeaveApprovalDegnApp();
	}
}