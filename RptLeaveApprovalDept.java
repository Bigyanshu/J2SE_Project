...
class RptLeaveApprovalDeptApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptLeaveApprovalDeptApp()
	{
		f1=new JFrame("Report of Staff Leave Approval Information Department-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Leave Approval Information ["+DepT+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblleaveapprov where Department='"+DepT+"'");
				slno=1;
				rw=0;
...
class RptLeaveApprovalDept
{
	public static void main(String[] s)
	{
		RptLeaveApprovalDeptApp rpt1=new RptLeaveApprovalDeptApp();
	}
}