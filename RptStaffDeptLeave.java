...
class RptStaffDeptLeaveApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptStaffDeptLeaveApp()
	{
		f1=new JFrame("Report of Staff Leave Information Department-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Leave Information ["+dept+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblleave where Department='"+dept+"'");
				slno=1;
				rw=0;
...
class RptStaffDeptLeave
{
	public static void main(String[] s)
	{
		RptStaffDeptLeaveApp rpt1=new RptStaffDeptLeaveApp();
	}
}