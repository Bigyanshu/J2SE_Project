...
class RptSalSlipDegnApp implements ActionListener
{
	JFrame f1;
	JPanel p1,p2;
	GridLayout gl51;
	...
	public RptSalSlipDegnApp()
	{
		f1=new JFrame("Report of Staff Salary Slip Information Designation-Wise");
		p1=new JPanel();
		p2=new JPanel();
	...
	public void doConnect()
	{
		...
		try
		{
			...
			{
				lHead.setText("Staff Salary Slip Information ["+degn+"]");
				rs=stmtSelect.executeQuery("select * from eiprs_tblsalslip where Designation='"+degn+"'");
				slno=1;
				rw=0;
...
class RptSalSlipDegn
{
	public static void main(String[] s)
	{
		RptSalSlipDegnApp rpt1=new RptSalSlipDegnApp();
	}
}